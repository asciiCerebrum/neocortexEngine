 ...
 * @author species8472
 */
public class FeatTypeObserverAccumulatorStrategyTest {

    private FeatTypeObserverAccumulatorStrategy strategy;

    public FeatTypeObserverAccumulatorStrategyTest() {
    }
    ...
    @Before
    public void setUp() {
        this.strategy = new FeatTypeObserverAccumulatorStrategy();
    }
    ...
    public void getObserversCorrectSizeTest() {
        final FeatType observerSource = new FeatType();
        final UniqueEntity targetEntity = new Weapon();

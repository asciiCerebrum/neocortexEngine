...
import org.asciicerebrum.mydndgame.BonusType;
...
public class AddBonusObserverTest {
    ...
    @Test
    public void testTriggerWithDirectBonus() {
        IBonus addBonus = mock(IBonus.class);
        this.abObserver.setAddBonus(addBonus);
        
        List<IBonus> boni = (List<IBonus>) this.abObserver
                .trigger(this.bonusList, this.character);
        assertEquals(addBonus, boni.get(0));
    }

...
public class CorrectAttackModeEvaluatorTest {
    ...
    public void evaluateCorrectTest() {
        ...
        when(this.situationContextService.getItemAttackMode(contextItem,
                (DndCharacter) dndCharacter)).thenReturn(this.weaponCategory);
    ...
    public void evaluateNullRefCategoryTest() {
        ...
        when(this.situationContextService.getItemAttackMode(contextItem,
                (DndCharacter) dndCharacter)).thenReturn(null);
